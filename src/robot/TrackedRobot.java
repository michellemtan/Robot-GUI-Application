...
public class TrackedRobot extends Robot {
	...
	/**
	 * Creates a TrackedRobot instance with specified values for instance variables.
	 * @param x x position.
	 * @param y y position.
	...
	/**
	 * Paints this TrackedRobot object using the supplied Painter object. This Robot
	 * is a different shape based on its input width.
	 */
